...
public:
    ...
    void exponentIso(string exp);
    void addSubIso(string express);
    void multDivIso(string express);
    void varIso(string express);
    void reduceVar(string express, string var);
};
string stringPrep(string exp);
